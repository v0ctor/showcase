...
Sec-WebSocket-Protocol: chat</code></pre>
    ...
    <section class="bibliography">
        ...
        <ul>
            ...
            <li>
                @lang('publications.enumeration', ['elements' => '<span class="name">Fette, I.</span>', 'last' => '<span class="name">Melnikov, A.</span>'])
                (2011).
            ...
            <li>
                @lang('publications.enumeration', ['elements' => '<span class="name">Kitamura, E.</span>', 'last' => '<span class="name">Ubl, M.</span>'])
                (2010).
                <a href="http://www.html5rocks.com/en/tutorials/websockets/basics/">Introducing WebSockets: Bringing
                    Sockets to the Web</a>.
                HTML5 Rocks.
                @lang('publications.consulted_on', ['date' => Formatter::date(2015, 10, 28)])
            </li>
            <li>
            ...
            <li>
                ...
                <a href="http://www.tiobe.com/index.php/content/paperinfo/tpci/index.html">TIOBE Index for November
                    2015</a>.
                @lang('publications.consulted_on', ['date' => Formatter::date(2015, 11, 8)])
            </li>
            <li>
                <span class="name">Web Hypertext Application Technology Working Group</span> (2015).
                @lang('publications.section', ['name' => '<em>Web sockets</em>', 'publication' => '<a href="https://html.spec.whatwg.org/multipage/comms.html#network">HTML5 Living Standard</a>'])
                , 9.3.
                @lang('publications.consulted_on', ['date' => Formatter::date(2015, 11, 1)])
            </li>
        </ul>
