...
@section('content')
	...
	<section>
		...
		<img style="width: 600px;" src="{{ asset('images/publications/bitcoin/digital-signature-' . App::getLocale() . '.png') }}">
	...
	<section class="bibliography">
		...
		<ul>
			<li>
				@lang('publications.enumeration', ['elements' => '<span class="name">Badev, A.</span>', 'last' => '<span class="name">Chen, M.</span>']) (2014).
				<a href="https://www.federalreserve.gov/econresdata/feds/2014/files/2014104pap.pdf">Bitcoin: Technical Background and Data Analysis</a>. Board of Governors of the Federal Reserve System.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 3, 28)])
			</li>
			<li>
				<span class="name">Fernández-Villaverde, J.</span> (2015).
				<a href="http://nadaesgratis.es/fernandez-villaverde/mis-aventuras-con-bitcoin-ii">Mis Aventuras con Bitcoin II: El Funcionamiento de Bitcoin</a>. Nada es gratis.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 3, 28)])
			</li>
			<li>
			...
			<li>
				...
				<a href="http://www.michaelnielsen.org/ddi/how-the-bitcoin-protocol-actually-works">How the Bitcoin protocol actually works</a>. Data-driven intelligence.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 3, 31)])
			</li>
			<li>
				<span class="name">Pacia, C.</span> (2013).
				<a href="https://chrispacia.wordpress.com/2013/09/02/bitcoin-mining-explained-like-youre-five-part-1-incentives">Bitcoin Mining Explained Like You’re Five: Part 1 – Incentives</a>. Escape Velocity.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 4, 4)])
			</li>
			<li>
				<span class="name">Pacia, C.</span> (2013).
				<a href="https://chrispacia.wordpress.com/2013/09/02/bitcoin-mining-explained-like-youre-five-part-2-mechanics">Bitcoin Mining Explained Like You’re Five: Part 2 – Mechanics</a>. Escape Velocity.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 4, 4)])
			</li>
			<li>
				<span class="name">Pacia, C.</span> (2013).
				<a href="https://chrispacia.wordpress.com/2013/09/07/bitcoin-cryptography-digital-signatures-explained">Bitcoin Explained Like You’re Five: Part 3 – Cryptography</a>. Escape Velocity.
				@lang('publications.consulted_on', ['date' => Formatter::date(2016, 4, 4)])
			</li>
		</ul>
	</section>
